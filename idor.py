...
def fuzz_idor(url, cookie, wordlist, search_string, delay=0.5, verbose=False):
    """Performs IDOR fuzzing by replacing 'FUZZ' in the URL with values from a wordlist.
    Prints any line from the response that contains the search_string.
    """
...
if __name__ == "__main__":
    ...
    fuzz_idor(args.url, args.cookie, args.wordlist, args.search, args.delay, args.verbose)
